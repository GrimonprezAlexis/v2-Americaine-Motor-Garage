...
export default function ReparationPage() {
  const services = [
    ...
    },
    {
      ...
      description: "Maintenance préventive pour garder votre véhicule en parfait état",
      features: [
        "Vidange moteur",
        "Filtration",
        "Freinage",
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Service multimarques spécialisé en véhicules américains et européens
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="mt-16 text-center bg-gray-900 rounded-xl p-8"
        >
          <h2 className="text-3xl font-bold text-white mb-6">
            Besoin d'un devis ?
          </h2>
          <p className="text-gray-400 mb-8">
            Contactez-nous pour obtenir un devis personnalisé pour votre véhicule
          </p>
          <a
            href="/contact"
